module processing_element #(
    ...
    multiplier #(
        .WIDTH(DATA_WIDTH),
        .FRAC_BITS(20),  // Assuming S3.20 format for multiplication
        .INT_BITS(3)
    ) mul (
        .a(data_in),
        .b(weight_in),
        .prod(mul_res),
        .overflow()  // Handle overflow as needed
    );
...
adder #(
    .WIDTH(24),      // Specify bit width
    .FRAC_BITS(20),  // Fractional bits
    .INT_BITS(3)     // Integer bits
) add_inst (
    .a(partial_in),
    .b(mul_res),
    .sum(add_res),
    .overflow(overflow_flag)  // Don't forget overflow signal!
);
